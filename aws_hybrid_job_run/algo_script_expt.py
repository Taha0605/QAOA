...
def Static_Model(G, edges, weights, source, destination, nodes):
    ...
    return [possible_states, counts, cost_opt]
...
def main():
    ...
    edges = [(1,2),(1,6),(2,3),(3,4),(4,5),(5,10),(6,7),(7,8),(8,9),(9,10)]
    weights = [1,5,1,1,1,1,1,1,1,1]
    G = nx.DiGraph()
    for i in range(len(edges)):
    ...
    #Function calls
    [possible_states, counts, cost_opt] = Static_Model(G, edges, weights, nodes, source, destination)
